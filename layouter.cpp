 ...
 *
 * There are a lot of text output libraries out there, but all of them only support basic
 ...
 * applications. This library is supposed to be in the middle between the heavyweight Pango
 * and the trivial libraries like SDL_ttf.
 *

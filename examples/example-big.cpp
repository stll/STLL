...
#include <stll/hyphenationdictionaries/hyph_de_DE.h>
...
int main ()
{
  ...
  addHyphenDictionary({"en"}, std::istringstream((const char*)hyph_en_US));
  addHyphenDictionary({"de"}, std::istringstream((const char*)hyph_de_DE));
...
//  styleSheet.addRule("h1", "text-shadow", "1px 1px 3px #F0F0F0, -1px -1px 3px #000000");
  ...
  styleSheet.addRule(".framed", "background-color", "#ffffff");
  styleSheet.addRule(".framed", "color", "#000000");
...
//  styleSheet.addRule("table", "direction", "rtl");
  ...
  std::string text = u8"<html><body>"
    ...
    "<p lang='en'>Test <i class='BigFont' class='und'>Text</i> more and somme ii "
    "<span class='BoldFont' class='und'>more text so</span> that the pa\u00ADra\u00ADgraph iiiiii is at least "
    "<span>long</span> enough to <a href='url1'>span some lines on the screen.</a> Also make it longer... by including some Wikipedia: "
    "Waddington first played for Yorkshire after the First World War, "
    "when the team had been weakened by injuries and retirements. He made "
    "an immediate impression in 1919, his first season; he took 100 wickets "
    "and was largely responsible for Yorkshire's victory in the County Championship "
    "that year. After a similarly successful season in 1920, he was selected "
    "for the 1920–21 Marylebone Cricket Club (MCC) tour of Australia, during "
    "which he appeared in two of the five Tests. However, the England team were "
    "outclassed; used in an unfamiliar tactical role, Waddington took just one "
    "wicket and never played for England again. He continued to be effective "
    "for Yorkshire, particularly against the weaker counties, but was often "
    "inconsistent. His reputation as an uncompromising opponent was cemented "
    "when he was found guilty of dissent and inciting the crowd in a game against "
    "Middlesex. A succession of injuries reduced his effectiveness and he retired "
    "from first-class cricket in 1927. He continued to play league cricket and "
    "worked for the family business, a fat-refining firm, but maintained his "
    "connection with Yorkshire cricket."
    ...
    "<p lang='de'>Um 1900 wurden auf dem Kästrich in Mainz Teile der mittelalterlichen Stadtmauer, "
    "die auf den Fundamenten der spätantiken römischen Stadtbefestigung ruhte, abgerissen. Bei "
    "diesen Arbeiten wurden in den Jahren 1898 bis 1911 zwischen den Straßen „Am Gautor“, „Bastion "
    "Martin“ und der „Martinstraße“ mehrere Architekturelemente des Dativius-Victor-Bogens gefunden, "
    "die als Spolien in der Stadtmauer verbaut gewesen waren.[1] Zunächst fielen den Arbeitern im "
    "November 1898 verzierte Blöcke auf. Nur diese wurden anschließend geborgen. Unverzierte "
    "Bauteile wurden abgeräumt. Karl Körber publizierte diese Funde als Teile von drei Monumenten. "
    "Bis 1903 wurden weitere Bauteile gefunden, so dass Heinrich Wallau erstmals einen "
    "Zusammenhang in diesen sah und 1906 eine erste Rekonstruktion des Bogens vorlegen konnte. "
    "Als Orientierung für ein passgenaues Aneinanderfügen dienten ihm und späteren Bearbeitern, "
    "neben der Dekoration, noch vorhandene Verschiebemarken und Klammerlöcher auf den Steinen.</p>"
    "<p class='cent'><img class='pframed' src='i1' width='110px' height='30px'/></p>"
    "<p lang='en' class='framed'>"
    "Waddington first played for Yorkshire after the First World War, "
    "when the team had been weakened by injuries and retirements. He made "
    "an immediate impression in 1919, his first season; he took 100 wickets "
    "and was largely responsible for Yorkshire's victory in the County Championship "
    ...
    "from first-class cricket in 1927. He continued to play league cricket and "
    "worked for the family business, a fat-refining firm, but maintained his "
    "connection with Yorkshire cricket.</p>"
...
"لكرة <span class='und'>القدم بسبب الشركة</span> القدم بسبب الشركة الراعية للبطولة إم.تي.إن، كانت النسخة السادسة والعشرون من كأس الأمم الأفريقية، "
  ...
  try {
    ...
    l[0].layout.addCommand(0, 0, TXT_WIDTH*64, l[1].layout.getHeight(), Color_c(0, 0, 0), 0);
